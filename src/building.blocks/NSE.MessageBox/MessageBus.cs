...
namespace NSE.MessageBus
{
    public class MessageBus : IMessageBus
    {
        ...
        // Na v7+, IsConnected fica dentro de Advanced
      ...
      where TResponse : ResponseMessage
        {
            TryConnect();
            // Adicionamos o 'await' para converter o AwaitableDisposable em IDisposable
        ...
        private void TryConnect()
        {
            ...
            policy.Execute(() =>
            {
                // Configuração com NewtonsoftJson para compatibilidade de tipos
                _bus = RabbitHutch.CreateBus(_connectionString, register => register.EnableNewtonsoftJson());
